...
from gait_recognition.HRNet.preparation import DatasetSimple
from gait_recognition.HRNet.Detector.tools.detector_yolov3 import DetectorYOLOv3
from gait_recognition.HRNet.Detector.tools.utils import non_max_suppression, rescale_boxes, preprocess_image
...
def detection(dataset_base_path, image_list, output_file):
    ...
    detector = DetectorYOLOv3(
        model_def="/content/drive/MyDrive/gait_recognition/HRNet/Detector/tools/config/yolov3.cfg",
        weights_path="/content/drive/MyDrive/gait_recognition/models/yolov3.weights",
    )
