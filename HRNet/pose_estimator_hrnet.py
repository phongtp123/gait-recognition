...
from gait_recognition.preparation import box_to_center_scale
import gait_recognition.HRNet.model_hrnet as model_hrnet
from gait_recognition.HRNet.config import _C as config, update_config
